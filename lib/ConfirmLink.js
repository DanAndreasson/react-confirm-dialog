...
var ConfirmLink = _react2.default.createClass({
  ...
  showHideConfirm: function showHideConfirm() {
    if (this.props.disabled) return this.state.showConfirm ? this.setState({ showConfirm: false }) : undefined;
    ...
    return _react2.default.createElement(
      ...
      this.state.showConfirm ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_ConfirmDialog2.default, _extends({}, this.props, { cancel: this.showHideConfirm }))
        )
      ) : ''
    );
  }
